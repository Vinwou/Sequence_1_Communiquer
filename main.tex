...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1.1\textwidth]{Images/pignon1.PNG} % Include the figure image
	\caption{Dessin de définition d'une pièce}
	\label{pignon1} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!75!ocre,title=Entrainement]\index{Entraînement}
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{pieceC} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{pieceCdraw} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{arbr2} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{definition}[Spécification géométrique]\index{Spécification géométrique}
...
\begin{theorem}[Intérêt des spécifications GPS :]
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{diag11} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H]\index{Méthode : spécif GPS} % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1.15\textwidth]{Images/diag12.png} 
	\caption{Méthode pour l'inscription des cotations GPS}
	\label{diag12} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H]\index{Méthode : spécif GPS} % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{forme} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H]\index{Méthode : spécif GPS} % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{pos} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H]\index{Méthode : spécif GPS} % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{ori} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
...
\begin{figure}[H]\index{Méthode : spécif GPS} % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{bat} % https://kastorcorp.be/la-perspective-part1/
\end{figure}
