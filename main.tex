...
Prenons l'exemple du BTS 2020. Certaines côtes ont des tolérances, comme ce diamètre :  \begin{tikzpicture}  {$ \varnothing 3^{ \begin{array}{l}
+0,20\\
-0
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=0.7\textwidth]{Images/port1.JPG} % Include the figure image
	\caption{Ouvre-portail}
	\label{Port1} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1\textwidth]{Images/port2.JPG} % Include the figure image
	\caption{Schéma SysML, modélisation fonctionnelle, schéma d'exigence.}
	\label{Port2} % Unique label used for referencing the figure in-text
\end{figure}
